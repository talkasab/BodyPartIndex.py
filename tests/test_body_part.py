...
from body_part_index import WHOLE_BODY_ID, BodyPart, BodyPartIndex
...
def test_is_contained(sample_body_part_index: BodyPartIndex):
    ...
    assert body_part1.is_contained(body_part2) is True
    assert body_part1.is_contained(body_part3) is False
