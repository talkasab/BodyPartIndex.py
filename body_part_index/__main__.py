...
from body_part_index import BODY_PART_INDEX_DATA_URL, WHOLE_BODY_ID, BodyPart, BodyPartIndex


def setup_argparse() -> argparse.ArgumentParser:
    """Setup argparse for body_part_index CLI."""
    parser = argparse.ArgumentParser(description="Command line interface for body_part_index package.")
    parser.add_argument(
        "-i",
        "-c",
        "--id_or_code",
